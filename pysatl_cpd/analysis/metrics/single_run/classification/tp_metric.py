...
class TruePositiveCount[TraceT: DetectionTrace, ProviderT: LabeledData](ClassificationPrimitive[TraceT, ProviderT]):
    ...
    def evaluate(self, run: SingleRun[TraceT, ProviderT]) -> int:
        ...
        return sum(bool(matches) for matches in matching.values())
